				...
				<div align="center" style="">
					...
					<div style="height:100px;width:390px;float:right">
						<div align="left" style="">
							<input style="width:300px;border: 1px solid #01a9fe;height:18px;" onkeup="showResult(document.getElementById('search').value,1,'xueye_consult')" id="search" type="text">
							<input style="" type="submit" id="submit" onclick="showResult(document.getElementById('search').value,1,'xueye_consult')" value="搜索答案">
						</div>
						<ul>
					...
					<div style="float:left;border: 1px solid #c9c9c9;width:798px;height:172px">
							...
							<ul>
								...
								<form action="post.php" method="post" onsubmit="">
									...
									<input type="hidden" name="type" value="xueye_my_question" />
