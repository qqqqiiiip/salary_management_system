...
<body>
    ...
    <?php
      ...
      $q="select * from tuan_shenqing where num='$username'and time='$time'";//设置查询指令
   ...
   ?>
  <input style="float:right" type="button" class="noprint" onclick="window.open('03-1-ed.php', 'newwindow', 'height=400px, width=800px, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no')" value="返回">
    <h1 align="center" >场地申请</h1>
    <form action="#" method="">
      <table id="customers">
        ...
        <tr><th>场地</th><td><?php echo $place; ?></td><th>时间段</th><td><?php echo $began_time; ?>至<?php echo $end_time; ?></td></tr>
